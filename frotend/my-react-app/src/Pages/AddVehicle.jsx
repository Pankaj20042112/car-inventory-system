  ...
  return (
    <div className="flex-grow py-12 px-4 max-w-2xl mx-auto w-full space-y-6">
      ...
      <div className="glass-panel p-8 rounded-3xl border border-white/5 shadow-2xl space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-white mb-1">Add Showroom Vehicle</h2>
          <p className="text-sm text-gray-400">Introduce a new vehicle record and photo to the active catalog.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Quantity */}
            <div className="flex flex-col space-y-1">
              <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Initial Stock</label>
              <input
                type="number"
                name="quantity"
                required
